...
plt.fill_between(x, yC, yT, where=(yT > yC),
                 facecolor=cList[1], alpha=0.85)  # 'blue', alpha=0.5)
plt.fill_between(x, yT, yC, where=(yT <= yC),
                 facecolor=cList[0], alpha=0.85)  # 'red', alpha=0.5)
plt.box()
